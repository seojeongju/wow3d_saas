...
import { Download, Search, Loader2, File, ImageIcon, Video, Archive, Code, Music, AlertCircle, RefreshCw, X, CheckCircle } from "lucide-react";
...
function getFileIcon(contentType: string) {
    if (contentType?.startsWith("image/")) return <ImageIcon className={styles.fileIconSvg} />;
    ...
    if (contentType?.includes("pdf") || contentType?.includes("word") || contentType?.includes("text")) return <File className={styles.fileIconSvg} />;
