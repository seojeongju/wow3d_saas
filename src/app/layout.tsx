...
export const metadata: Metadata = {
  ...
  keywords: ["와우쓰리디", "WOW3D", "(주)와우쓰리디", "와우3D", "스마트공장", "스마트제조", "스마트상점", "스마트서비스", "정부지원사업", "공식공급업체", "3D프린팅", "시제품제작", "3D프린터출력", "소프트웨어", "ERP", "MES", "CRM", "LMS", "전사적자원관리", "생산관리", "고객관리", "학사관리", "무료 3D 뷰어", "무료 STL 뷰어", "STL 뷰어", "무료 QR 생성기", "QR코드 만들기", "와이파이 QR 코드", "이미지 SVG 변환", "무료 SVG 변환기", "소상공인 지원사업", "스마트상점 기술보급", "기업 소프트웨어 개발", "업무자동화 솔루션", "지능형 공장 구축", "제조업 ERP", "CRM 고객관리", "3D프린터 시제품", "공식 공급기업", "정부지원 무상솔루션"],
